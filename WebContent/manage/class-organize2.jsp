	...
	<div>
		...
		<table>
			...
			<tr>
				...
				<c:forEach begin="1" end="${number}" varStatus="i">
				<td><input type="radio" name="class_no[${status.index}]" value="${i.count}"></td>
				</c:forEach>
				<td><input type="radio" name="class_no[${status.index}]" value="0"></td>
			</tr>
			</c:forEach>
		</table>
		</div>
...
<script>
	var buttonOpen = document.getElementByName('class_no['+1+']');
