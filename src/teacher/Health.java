...
@WebServlet(urlPatterns = { "/teacher/health" })
public class Health extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            // 健康状態をすべて取得
            List<bean.Health> list = new HealthDAO().all();
            ...
            out.println("<a href='/Team-E/teacher/Money.jsp'>集金</a>");
            out.println("<a href='/Team-E/teacher/temperature.jsp'>体温</a>");
